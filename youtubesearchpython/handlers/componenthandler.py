...
class ComponentHandler:
    ...
    def _getVideoShortComponent(self, element: dict, shelfTitle: str = None) -> dict:
        video = element[videoElementKey]
        component = {
            'type':                           'video',
            'id':                              self._getValue(video, ['videoId']),
    ...
    def _getShortsComponent(self, element: dict, shelfTitle: str = None) -> dict:
        video = element[shortsElementKey]
        component = {
            'type':                           'video',
            'id':                              self._getValue(video, ['onTap', 'innertubeCommand', 'reelWatchEndpoint', 'videoId']),
            'title':                           self._getValue(video, ['accessibilityText']),
            # 'publishedTime':                   self._getValue(video, ['publishedTimeText', 'simpleText']),
            # 'duration':                        self._getValue(video, ['lengthText', 'simpleText']),
            # 'viewCount': {
            #     'text':                        self._getValue(video, ['viewCountText', 'simpleText']),
