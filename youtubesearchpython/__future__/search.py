...
class Search(SearchCore):
    ...
    def __init__(self, query: str, limit: int = 20, language: str = 'en', region: str = 'US', timeout: Optional[int] = None, async_client: Optional[httpx.AsyncClient] = None):
        ...
        super().__init__(query, limit, language, region, None, timeout, short_component = short_component, async_client = async_client)  # type: ignore
...
class VideosSearch(SearchCore):
    ...
    '''
    def __init__(self, query: str, limit: int = 20, language: str = 'en', region: str = 'US', timeout: Optional[int] = None, short_component: bool = False, async_client: Optional[httpx.AsyncClient] = None):
        self.searchMode = (True, False, False)
        super().__init__(query, limit, language, region, SearchMode.videos, timeout, short_component = short_component, async_client = async_client)  # type: ignore
...
class ChannelsSearch(SearchCore):
    ...
    def __init__(self, query: str, limit: int = 20, language: str = 'en', region: str = 'US', timeout: Optional[int] = None, short_component: bool = False, async_client: Optional[httpx.AsyncClient] = None):
        ...
        super().__init__(query, limit, language, region, SearchMode.channels, timeout, short_component = short_component, async_client = async_client)  # type: ignore
...
class PlaylistsSearch(SearchCore):
    ...
    def __init__(self, query: str, limit: int = 20, language: str = 'en', region: str = 'US', timeout: Optional[int] = None, short_component: bool = False, async_client: Optional[httpx.AsyncClient] = None):
        ...
        super().__init__(query, limit, language, region, SearchMode.playlists, timeout, short_component = short_component, async_client = async_client)  # type: ignore
...
class CustomSearch(SearchCore):
    ...
    '''
    def __init__(self, query: str, searchPreferences: str, limit: int = 20, language: str = 'en', region: str = 'US', timeout: Optional[int] = None, short_component: bool = False, async_client: Optional[httpx.AsyncClient] = None):
        self.searchMode = (True, True, True)
        super().__init__(query, limit, language, region, searchPreferences, timeout, short_component = short_component, async_client = async_client)  # type: ignore
...
class ChannelSearch(ChannelSearchCore):
    ...
    def __init__(self, query: str, browseId: str, language: str = 'en', region: str = 'US', searchPreferences: str = "EgZzZWFyY2g%3D", timeout: Optional[int] = None, short_component: bool = False, async_client: Optional[httpx.AsyncClient] = None):
        super().__init__(query, language, region, searchPreferences, browseId, timeout, short_component = short_component, async_client = async_client)  # type: ignore
