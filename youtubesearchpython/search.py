...
class Search(SearchCore):
    ...
    '''
    def __init__(self, query: str, limit: int = 20, language: str = 'en', region: str = 'US', timeout: int = None, short_component: bool = False):
        self.searchMode = (True, True, True)
        super().__init__(query, limit, language, region, None, timeout, short_component = short_component)
        self.sync_create()
...
class VideosSearch(SearchCore):
    ...
    def __init__(self, query: str, limit: int = 20, language: str = 'en', region: str = 'US', timeout: int = None, short_component: bool = False):
        ...
        super().__init__(query, limit, language, region, SearchMode.videos, timeout, short_component = short_component)
        self.sync_create()
        self._getComponents(*self.searchMode)
...
class ChannelsSearch(SearchCore):
    ...
    def __init__(self, query: str, limit: int = 20, language: str = 'en', region: str = 'US', timeout: int = None, short_component: bool = False):
        ...
        super().__init__(query, limit, language, region, SearchMode.channels, timeout, short_component = short_component)
        self.sync_create()
        self._getComponents(*self.searchMode)
...
class PlaylistsSearch(SearchCore):
    ...
    def __init__(self, query: str, limit: int = 20, language: str = 'en', region: str = 'US', timeout: int = None, short_component: bool = False):
        ...
        super().__init__(query, limit, language, region, SearchMode.playlists, timeout, short_component = short_component)
        self.sync_create()
        self._getComponents(*self.searchMode)
...
class ChannelSearch(ChannelSearchCore):
    ...
    def __init__(self, query: str, browseId: str, language: str = 'en', region: str = 'US', searchPreferences: str = "EgZzZWFyY2g%3D", timeout: int = None, short_component: bool = False):
        super().__init__(query, language, region, searchPreferences, browseId, timeout, short_component = short_component)
        self.sync_create()
...
class CustomSearch(SearchCore):
    ...
    '''
    def __init__(self, query: str, searchPreferences: str, limit: int = 20, language: str = 'en', region: str = 'US', timeout: int = None, short_component: bool = False):
        self.searchMode = (True, True, True)
        super().__init__(query, limit, language, region, searchPreferences, timeout, short_component = short_component)
        self.sync_create()
        self._getComponents(*self.searchMode)
